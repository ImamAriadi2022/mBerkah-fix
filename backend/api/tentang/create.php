...
$stmt = $db->prepare("INSERT INTO tentang SET history=:history, employees=:employees, location=:location, google_map_link=:google_map_link, google_map_embed=:google_map_embed");
...
if($stmt->execute()) {
    echo json_encode(array("message" => "Tentang was created."));
} else {
    echo json_encode(array("message" => "Unable to create tentang."));
